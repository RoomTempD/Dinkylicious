...
#End Region
    ...
    Public Sub StoolCheck(ByVal X As Integer)
        'only bar comp will access this
        ...
        If Saved.OpenStoolInfoRST.NoMatch = False Then
            ...
            If Saved.OpenStoolInfoAvailable.Value = True Then
                ...
                Saved.OpenStoolInfoAvailable.Value = False
                Saved.OpenStoolInfoReTable.Value = Saved.SavedReTable.Value

                Saved.OpenTicketRST.AddNew()
                Saved.OpenTicketStoolNum.Value = X
            ...
            Else
                ...
                Saved.OpenTicketRST.FindFirst("STOOL_NUM = " & X & " AND TABLE_NUM = 0")
        ...
        If Saved.OpenTableInfoRST.NoMatch = False Then
            ...
            If Saved.OpenTableInfoAvailable.Value = True Then
                ...
                If Saved.GO(0) = True Then
                    'If an amout of guests was entered

                    If TABLETOSEAT = 0 Then
                        'If there is not a Bar Stool selected and table is available

                        Saved.OpenTableInfoRST.Edit()
                        Saved.OpenTableInfoAvailable.Value = False
                        ...
                        Saved.OpenTableInfoEmpNum1.Value = Saved.CURSERVER

                        Saved.OpenTableInfoEmpNum2.Value = 0
                        Saved.OpenTableInfoReTable.Value = Saved.SavedReTable.Value
                        Saved.OpenTableInfoStoolNum.Value = 0
                        Saved.OpenTableInfoTipAtBar.Value = "NO"

                        Saved.OpenTicketRST.AddNew()
                        Saved.OpenTicketTableNum.Value = X
                        Saved.OpenTicketTicketNum.Value = Saved.SavedTicketNum.Value
                        Saved.OpenTicketGuestNum.Value = 1
                        Saved.OpenTicketOrderNum.Value = Saved.SavedOrderNum.Value
                        Saved.OpenTicketTimeIn.Value = Format(Now(), "Short Time")
                        Saved.OpenTicketDateIn.Value = Format(Now(), "Short Date")
                        Saved.OpenTicketReTable.Value = Saved.SavedReTable.Value
                        Saved.OpenTicketTipAtBar.Value = "NO"
                        Saved.OpenTicketTippedOn.Value = 0
                        Saved.OpenTicketTimeSat.Value = Format(Now(), "Short Time")
                        ...
                        GO(1) = True
                    Else
                        'If there is a Bar Stool selected and table is available

                        Saved.OpenStoolInfoRST.FindFirst("STOOL_NUM = " & TABLETOSEAT)
                        If Saved.OpenStoolInfoRST.NoMatch = False Then
                            'Load record of selected stool

                            Saved.OpenTableInfoRST.Edit()
                            Saved.OpenTableInfoAvailable.Value = False
                            Saved.OpenTableInfoStoolNum.Value = TABLETOSEAT
                            If Saved.BarSeat = True Then
                                Saved.OpenTableInfoGuestCount.Value = 0
                                Saved.OpenTableInfoEmpNum1.Value = -5
                            Else
                                Saved.OpenTableInfoGuestCount.Value = Saved.CURGUESTCOUNT
                                Saved.OpenTableInfoEmpNum1.Value = Saved.CURSERVER
                            End If
                            Saved.OpenTableInfoEmpNum2.Value = 0
                            Saved.OpenTableInfoReTable.Value = Saved.OpenStoolInfoReTable.Value
                            Saved.OpenTableInfoTipAtBar.Value = "NEED"
                        ...
                        Do Until Saved.OpenTicketRST.EOF
                            If Saved.OpenTicketStoolNum.Value = TABLETOSEAT Then
                                Saved.OpenTicketRST.Edit()
                                Saved.OpenTicketStoolNum.Value = Saved.OpenTicketStoolNum.Value * -1
                                Saved.OpenTicketTableNum.Value = X
                                Saved.OpenTicketTippedOn.Value = Saved.OpenTicketBarTotal.Value + Saved.OpenTicketFoodTotal.Value
                                Saved.OpenTicketTimeSat.Value = Format(Now(), "Short Time")
                                Saved.CURORDER = Saved.OpenTicketOrderNum.Value
                                Saved.CURRETABLE = Saved.OpenTicketReTable.Value
                                Saved.OpenTicketRST.Update()
                            End If
            ...
            Else
                ...
                If TABLETOSEAT = 0 Then
                    'if table exists and don't need to seat

                    Saved.OpenTicketRST.FindFirst("TABLE_NUM = " & X)
                    If Saved.OpenTicketRST.NoMatch = False Then
                        'Load record of table

                        If Saved.OpenTableInfoEmpNum1.Value = Saved.CURSERVER Or Saved.OpenTableInfoEmpNum2.Value = Saved.CURSERVER Then
                            'if server owns table 

                            Saved.CURTICKET = Saved.OpenTicketTicketNum.Value
                            Saved.CURORDER = Saved.OpenTicketOrderNum.Value
                            Saved.CURRETABLE = Saved.OpenTicketReTable.Value
                            Saved.GO(1) = True
                        ElseIf Saved.OpenTableInfoEmpNum1.Value = -5 Then

                            Dim ANS
                            ANS = MsgBox("Are you sure you want to claim this table?", vbYesNo, "Confirmation")
                            If ANS = MsgBoxResult.Yes Then
                                Saved.OpenTableInfoRST.Edit()

                                Dim formGuestCount As New EnterGuestCount
                                Saved.GO(0) = False
                                formGuestCount.ShowDialog()
                                'Get the number of guests
                            ...
                            End If
                            Else
                                Dim Box As MsgBoxResult = MsgBox("This is not your table, are you sure you want to open it?", MsgBoxStyle.YesNo)
                    ...
                    End If
                Else
                    'If trying to seat at unavailable table
        ...
        Else
            ...
            If Saved.GO(0) = True Then
                ...
                If TABLETOSEAT = 0 Then
                    ...
                    Saved.OpenTableInfoRST.AddNew()
                    Saved.OpenTableInfoTableNum.Value = X
                    Saved.OpenTableInfoTableName.Value = "Custom " & X
                    Saved.OpenTableInfoAvailable.Value = False
                    Saved.OpenTableInfoGuestCount.Value = Saved.CURGUESTCOUNT
                    Saved.OpenTableInfoEmpNum1.Value = Saved.CURSERVER
                    Saved.OpenTableInfoEmpNum2.Value = 0
    ...
    Private Sub sto_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sto10.Click, sto11.Click, sto12.Click, sto13.Click, sto14.Click, sto15.Click, sto16.Click, sto17.Click, sto18.Click, sto19.Click, sto20.Click, sto21.Click, sto22.Click, sto23.Click, sto24.Click, sto25.Click, sto01.Click, sto02.Click, sto03.Click, sto04.Click, sto05.Click, sto06.Click, sto07.Click, sto08.Click, sto09.Click, sto10.Click, sto11.Click, sto12.Click, sto13.Click, sto14.Click, sto15.Click, sto16.Click, sto17.Click, sto18.Click, sto19.Click, sto20.Click, sto21.Click, sto22.Click, sto23.Click, sto24.Click, sto25.Click
        ...
        If Saved.LOGON = "SERVER" Or Saved.BarSeat = True Then
            ...
            Saved.OpenStoolInfoRST.FindFirst("STOOL_NUM = " & Mid(sender.name, 4, 2))
        ...
        Do Until Saved.OpenTableInfoRST.EOF
            If Saved.OpenTableInfoTableNum.Value < 25 And Not Saved.OpenTableInfoTableNum.Value = -99 Then
                ...
                Else
                    ...
                    If Saved.OpenTicketRST.NoMatch = False Then
                        If Saved.OpenTableInfoEmpNum1.Value = Saved.CURSERVER Or Saved.OpenTableInfoEmpNum2.Value = Saved.CURSERVER Then
                            isOWN(Saved.OpenTableInfoTableNum.Value) = True
                        Else
                            isOWN(Saved.OpenTableInfoTableNum.Value) = False
                        End If
                        If Saved.OpenTableInfoEmpNum1.Value = -5 Then
                            CLAIM = True
                        End If
                    End If
                End If
    ...
    Private Sub cmdOtherTable_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOtherTable.Click
        Saved.Database_Connect()
        Saved.Saved_Open()
        Dim tmpTable As Integer

        Saved.SavedRST.Edit()
        Saved.SavedTableNum.Value = Saved.SavedTableNum.Value + 1
        tmpTable = Saved.SavedTableNum.Value
        Saved.SavedRST.Update()
